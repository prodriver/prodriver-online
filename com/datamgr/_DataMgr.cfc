...
<cfset variables.DataMgrVersion = "2.5 Beta 2">
		...
		<cfcase value="list">
			<cfset hasOtherFieldVal = (
				...
				AND	(
					...
					OR	isOfType(arguments.OtherVal,getEffectiveFieldDataType(getField(arguments.tablename,sField.Relation["other-field"]),true))
				)
			)>
